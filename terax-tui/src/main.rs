...
fn doctor_text()->String{
    ...
    out.push_str(&format!("cwd: {}\n", std::env::current_dir().map(|p|p.display().to_string()).unwrap_or_else(|e|format!("ERR {e}"))));
